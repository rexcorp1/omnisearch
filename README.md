...
[![DeepWiki](https://img.shields.io/badge/DeepWiki-miurla%2Fmorphic-blue.svg?logo=data:image/png;base64,)](https://deepwiki.com/miurla/omnisearch) [![GitHub stars](https://img.shields.io/github/stars/miurla/omnisearch?style=flat&colorA=000000&colorB=000000)](https://github.com/miurla/omnisearch/stargazers) [![GitHub forks](https://img.shields.io/github/forks/miurla/omnisearch?style=flat&colorA=000000&colorB=000000)](https://github.com/miurla/omnisearch/network/members)
...
We're excited to announce the v1.0.0 pre-release is now available for beta testing at [beta.omnisearch.sh](https://beta.omnisearch.sh)!
...
- **For testing and feedback**: Use the `v1.0.0` branch or visit [beta.omnisearch.sh](https://beta.omnisearch.sh)

### Help Us Improve

Found a bug or have suggestions? We'd love to hear from you:

- 🐛 [Report issues on GitHub](https://github.com/miurla/omnisearch/issues)
- 💬 Use the feedback button in the header at [beta.omnisearch.sh](https://beta.omnisearch.sh) for quick feedback
- 🤝 Contribute to the beta testing effort

Your feedback helps make Omnisearch better for everyone!
...
```bash
DATABASE_URL=postgresql://omnisearch:omnisearch@postgres:5432/omnisearch
OPENAI_API_KEY=your_openai_key
TAVILY_API_KEY=your_tavily_key
...
```bash
POSTGRES_USER=omnisearch      # Default: omnisearch
POSTGRES_PASSWORD=omnisearch  # Default: omnisearch
POSTGRES_DB=omnisearch        # Default: omnisearch
...
- Start the Omnisearch application
...
Host your own live version of Omnisearch with Vercel or Docker.
